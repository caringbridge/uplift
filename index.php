    ...
    <div class="container clearfix">
        <div class="row">
            <div class="span8">
                ...
                <div class="pagingNav">
                    <p><?php posts_nav_link('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;','&laquo; previous','next &raquo;'); ?></p>
                </div>
            </div>
            ...
            <div class="span4">
                <?php get_sidebar(); ?>
                 ...
                 <div class="rssButton">
                    <a href="<?php bloginfo('rss2_url'); ?>" onclick="_gaq.push(['_trackEvent', 'Blog', 'Click - link', 'RSS Feed']);" >Uplift RSS Feed<img src="<?php bloginfo('template_directory'); ?>/img/rss-feed-icon.png" alt="Uplift RSS Feed Icon"></a>

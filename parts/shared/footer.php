      ...
      <footer data-ga-label-prefix="Footer - " id="brand-footer">
        <nav id="fat-footer">
            <div class="fat-footer-links">
                ...
                <ul>
                    ...
                    <li><a href="/" class="normal-case">SupportPlanner</a></li>
        ...
        <div class="clearfix">
            ...
            <!-- 
                <?php //wp_footer(); ?>
            -->
            <p id="copyright"><a href="http://www.caringbridge.org/copyright">Copyright</a> &copy; 1997-2012 CaringBridge&reg;, a nonprofit organization</p>
